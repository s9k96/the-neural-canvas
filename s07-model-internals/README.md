...
```bash
.venv/Scripts/python s07-model-internals/run_demo.py    # 8 experiments, 13 gates, ~70 s, CPU
.venv/Scripts/python s07-model-internals/dynkron.py     # codec self-check
```
